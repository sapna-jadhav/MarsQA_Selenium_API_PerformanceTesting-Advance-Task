   ...
   public class Base
    {
		...
		public static void TearDown()
		{
			...
			// Screenshot
			String img = SaveScreenshot.SaveScreenshotClass(GlobalDefinitions.driver, "Report");//AddScreenCapture(@"E:\Dropbox\VisualStudio\Projects\Beehive\TestReports\ScreenShots\");
